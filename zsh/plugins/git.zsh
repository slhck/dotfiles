# Git aliases/functions extracted from oh-my-zsh
...
# Helper: git wrapper (from lib/git.zsh)
function __git_prompt_git() {
  GIT_OPTIONAL_LOCKS=0 command git "$@"
}

# Helper: get current branch name (from lib/git.zsh)
...
# Git plugin (plugins/git/git.plugin.zsh)
